...
PATHWAY_PROJECTS = {
    ...
    "Effective Coaching": {
        ...
        2: {"title": "Learning Your Style",       "required": ["Understanding Your Communication Style","Active Listening","Introduction to Toastmasters Mentoring"], "elective_count": 0},
    ...
    "Team Collaboration": {
        1: {"title": "Mastering Fundamentals",    "required": ["Ice Breaker","Evaluation and Feedback","Researching and Presenting"], "elective_count": 0},
        2: {"title": "Learning Your Style",       "required": ["Understanding Your Leadership Style","Active Listening"], "elective_count": 0},
        3: {"title": "Increasing Knowledge",      "required": ["Successful Collaboration"], "elective_count": 1},
        4: {"title": "Building Skills",           "required": ["Motivate Others"], "elective_count": 1},
    ...
    "Engaging Humor": {
        1: {"title": "Mastering Fundamentals",    "required": ["Ice Breaker","Evaluation and Feedback","Researching and Presenting"], "elective_count": 0},
        2: {"title": "Learning Your Style",       "required": ["Connect with Your Audience","Introduction to Toastmasters Mentoring"], "elective_count": 0},
